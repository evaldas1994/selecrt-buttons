...
class StockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'f_price_sale3' => 'numeric|between:0,9999999999.9999|regex:/^\d+(\.\d{1,4})?$/|regex:/^\d+(\.\d{1,4})?$/',
            ...
            'f_weightsign' => 'integer',
            'f_product' => 'integer',
            'f_locked' => 'integer',
            'f_system1' => 'string|max:100|nullable',
            'f_system2' => 'string|max:100|nullable',
            'f_system3' => 'string|max:100|nullable',
            'f_scalesign' => 'integer|nullable',
            ...
            'f_mark1' => 'integer|nullable',
            'f_mark2' => 'integer|nullable',
            'f_mark3' => 'integer|nullable',
            'f_mark4' => 'integer|nullable',
            'f_mark5' => 'integer|nullable',
            'f_mark6' => 'integer|nullable',
            'f_mark7' => 'integer|nullable',
            'f_mark8' => 'integer|nullable',
            'f_order_block' => 'integer',
            'f_sales_block' => 'integer',
            'f_purch_block' => 'integer',
            ...
            'f_gpais_i' => 'integer|nullable',
            'f_gpais_n' => 'integer|nullable',
            'f_gpais_a' => 'integer|nullable',
            'f_empty_pack' => 'integer|nullable',
            'f_pack_type' => 'integer|nullable',
            'f_gross_weight' => 'numeric|between:0,9999999999.9999|regex:/^\d+(\.\d{1,4})?$/',
            'f_catalog_item' => 'integer|nullable',
            'f_disp_priority' => 'integer|nullable',
            'f_alternative_group_id' => 'string|max:20|nullable',
            'f_imgurl' => 'string|max:500|nullable',
            'f_ignor_gross_wight' => 'integer|nullable',
            'f_prevent_manual_entry' => 'integer|nullable',
