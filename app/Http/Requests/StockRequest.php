...
class StockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'f_mark1' => 'boolean|nullable',
            'f_mark2' => 'boolean|nullable',
            'f_mark3' => 'boolean|nullable',
            'f_mark4' => 'boolean|nullable',
            'f_mark5' => 'boolean|nullable',
            'f_mark6' => 'boolean|nullable',
            'f_mark7' => 'boolean|nullable',
            'f_mark8' => 'boolean|nullable',
            ...
            'f_gpais_i' => 'boolean|nullable',
            'f_gpais_n' => 'boolean|nullable',
            'f_gpais_a' => 'boolean|nullable',
            'f_empty_pack' => 'boolean|nullable',
            'f_pack_type' => 'integer|nullable',
            'f_gross_weight' => 'numeric|between:0,9999999999.9999|regex:/^\d+(\.\d{1,4})?$/',
            'f_catalog_item' => 'boolean|nullable',
            'f_disp_priority' => 'integer|nullable',
            'f_alternative_group_id' => 'string|max:20|nullable',
            'f_imgurl' => 'string|max:500|nullable',
            'f_ignor_gross_wight' => 'boolean|nullable',
            'f_prevent_manual_entry' => 'boolean|nullable',
