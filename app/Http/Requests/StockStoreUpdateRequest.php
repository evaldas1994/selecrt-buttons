...
class StockStoreUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'f_type' => ['required', Rule::in(Stock::$types)],
            'f_groupid' => 'nullable|exists:t_stockgroup,f_id',
            'f_unitid' => 'required|exists:t_unit,f_id',
            'f_pack_unitid' => 'nullable|exists:t_unit,f_id',
            'f_pack_quant' => ['required', 'numeric', new FloatRule(4)],
            'f_volume' => ['required', 'numeric', new FloatRule(4)],
            'f_weight' => ['required', 'numeric', new FloatRule(4)],
            ...
            'f_price_purch' => ['required', 'numeric', new FloatRule(4)],
            'f_price_sale1' => ['required', 'numeric', new FloatRule(4)],
            'f_price_sale2' => ['required', 'numeric', new FloatRule(4)],
            'f_price_sale3' => ['required', 'numeric', new FloatRule(4)],
            'f_price_sale4' => ['required', 'numeric', new FloatRule(4)],
            'f_price_sale5' => ['required', 'numeric', new FloatRule(4)],
            ...
            'f_min_quant' => ['required', 'numeric', new FloatRule(4)],
            ...
            'f_quantity' => ['required', 'numeric', new FloatRule(4)], //on palette
            ...
            'f_height' => ['required', 'numeric', new FloatRule(4)],
            'f_width' => ['required', 'numeric', new FloatRule(4)],
            'f_length' => ['required', 'numeric', new FloatRule(4)],
            'f_image' => 'bytea|nullable',
            'f_gpais_i' => 'boolean',
            'f_gpais_n' => 'boolean',
            'f_gpais_a' => 'boolean',
            'f_empty_pack' => 'boolean',
            'f_pack_type' => ['required', Rule::in(Stock::$gpaisPacTypes)],
            'f_gross_weight' => ['required', 'numeric', new FloatRule(4)],
            ...
            'f_diviation_percentage' => ['required', 'numeric', new FloatRule(2)],
        ];
    }
}
