...
class Create extends Component
{
    ...
    public function mount($productionsh, $productionCards, $stores, $registers1, $registers2, $registers3, $registers4, $registers5)
    {
        ...
        $this->setOldValue('f_bomid');
        $this->setOldValue('f_quant', '1.0000');
        $this->setOldValue('f_description');
        $this->setOldValue('f_storeid');
        $this->setOldValue('f_f1');
        $this->setOldValue('f_f2');
        $this->setOldValue('f_f3');
        $this->setOldValue('f_f4');
        $this->setOldValue('f_f5');
    ...
    {
        return view('livewire.productiond.create');
    }
