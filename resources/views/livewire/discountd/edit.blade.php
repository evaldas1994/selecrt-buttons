...
<div class="fixed-bottom">
    <div class="row mb-2">
        <div class="col-auto ms-auto text-end mt-n1">
            <x-form-elements.button
                form="discountd_edit_form"
                class="btn-primary"
                text="global.btn_save"
            />

            <button wire:click="$emitUp('showEditDiscountd', false)"
    ...
    <div class="row">
        <form id="discountd_edit_form"
              action="{{ route('discountsd.update', [$discountsh, $discountsd]) }}" method="POST">
            @csrf
            @method('PUT')
