...
@section('content')
    ...
    <div class="row">
        <form id="price-partner-form" action="{{ route('price-partners.update', [$partner, $pricePartner]) }}" method="POST">
            @csrf
            @method('PUT')
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    ...
                                    <select
                                        ...
                                        @foreach($stocks as $stock)
                                            <option
                                                value="{{ $stock->f_id }}" {{ selected('f_stockid', $stock->f_id, $pricePartner->f_stockid) }}>{{ $stock->f_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_quant"
                                           maxlength="13"
                                           value="{{ old('f_quant', $pricePartner->f_quant)}}">
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_price"
                                           maxlength="15"
                                           value="{{ old('f_price', $pricePartner->f_price)}}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_vat_perc"
                                           maxlength="6"
                                           value="{{ old('f_vat_perc', $pricePartner->f_vat_perc)}}">
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('f_valid_from', $pricePartner->f_valid_from) }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input
                                        ...
                                        name="f_valid_till"
                                        placeholder="@lang('global.select_date')"
                                        value="{{ old('f_valid_till', $pricePartner->f_valid_till) }}">
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    <label class="form-check m-0">
                                        ...
                                        <input type="checkbox" name="f_active"
                                               ...
                                               value="{{ old('f_active', 1) }}" {{ old('f_active', $pricePartner->f_active) == 1 ? 'checked' : '' }}>
                                    </label>
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system1"
                                           maxlength="100"
                                           value="{{ old('f_system1', $pricePartner->f_system1) }}">
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system2"
                                           maxlength="100"
                                           value="{{ old('f_system2', $pricePartner->f_system2) }}">
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system3"
                                           maxlength="100"
                                           value="{{ old('f_system3', $pricePartner->f_system3) }}">
