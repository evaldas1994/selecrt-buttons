                    ...
                    <form id="stock-form" action="{{ route('stocks.store') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="not-empty form-control form-control-sm @error('f_unitid') is-invalid @enderror" name="f_unitid">
                                @foreach($units as $unit)
                                    <option value="{{ $unit->f_id }}" {{ selected('f_unitid', $unit->f_id, $defaultUnit)}}>{{ $unit->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_pack_unitid') is-invalid @enderror" name="f_pack_unitid">
                                <option value selected>---</option>
                                @foreach($units as $unit)
                                    <option value="{{ $unit->f_id }}" {{ selected('f_pack_unitid', $unit->f_id) }}>{{ $unit->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_manufacturerid') is-invalid @enderror" name="f_manufacturerid">
                                ...
                                @foreach($manufacturers as $manufacturer)
                                    <option value="{{ $manufacturer->f_id }}" {{ selected('f_manufacturerid', $manufacturer->f_id) }}>{{ $manufacturer->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_discid') is-invalid @enderror" name="f_discid">
                                ...
                                @foreach($discountsh as $discounth)
                                    <option value="{{ $discounth->f_id }}" {{ selected('f_discid', $discounth->f_id) }}>{{ $discounth->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="not-empty form-control form-control-sm @error('f_vatid') is-invalid @enderror" name="f_vatid">
                                <option value selected>---</option>
                                @foreach($vats as $vat)
                                    <option value="{{ $vat->f_id }}" {{ selected('f_vatid', $vat->f_id) }}>{{ $vat->f_id }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_alternative_group_id') is-invalid @enderror" name="f_alternative_group_id">
                                <option value selected>---</option>
                                @foreach($stockGroups as $group)
                                    <option value="{{ $group->f_id }}" {{ selected('f_alternative_group_id', $group->f_id) }}>{{ $group->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_empty_pack" class="form-check-input @error('f_empty_pack') is-invalid @enderror" value="{{ old('f_empty_pack', 1) }}"  {{ old('f_empty_pack') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_type') is-invalid @enderror" name="f_type">
                                @foreach($types as $type)
                                    <option value="{{ $type }}" {{ selected('f_type', $type) }}>@lang('modules/stock.type' . $type)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_weightsign" class="form-check-input @error('f_weightsign') is-invalid @enderror" value="{{ old('f_weightsign', 1) }}"  {{ old('f_weightsign') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_product" class="form-check-input @error('f_product') is-invalid @enderror" value="{{ old('f_product', 1) }}"  {{ old('f_product') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_scalesign" class="form-check-input @error('f_scalesign') is-invalid @enderror" value="{{ old('f_scalesign', 1) }}"  {{ old('f_scalesign') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_curid') is-invalid @enderror" name="f_curid">
                                ...
                                @foreach($currencies as $currency)
                                    <option value="{{ $currency->f_id }}" {{ selected('f_curid', $currency->f_id) }}>{{ $currency->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_partnerid') is-invalid @enderror" name="f_partnerid">
                                ...
                                @foreach($partners as $partner)
                                    <option value="{{ $partner->f_id }}" {{ selected('f_partnerid', $partner->f_id) }}>{{ $partner->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_main_stockid') is-invalid @enderror" name="f_main_stockid">
                                ...
                                @foreach($stocks as $singleStock)
                                    <option value="{{ $singleStock->f_id }}" {{ selected('f_main_stockid', $singleStock->f_id) }}>{{ $singleStock->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_r1id') is-invalid @enderror" name="f_r1id">
                                ...
                                @foreach($registers1 as $register)
                                    <option value="{{ $register->f_id }}" {{ selected('f_r1id', $register->f_id) }}>{{ $register->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_r2id') is-invalid @enderror" name="f_r2id">
                                ...
                                @foreach($registers2 as $register)
                                    <option value="{{ $register->f_id }}" {{ selected('f_r2id', $register->f_id) }}>{{ $register->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_r3id') is-invalid @enderror" name="f_r3id">
                                ...
                                @foreach($registers3 as $register)
                                    <option value="{{ $register->f_id }}" {{ selected('f_r3id', $register->f_id) }}>{{ $register->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_r4id') is-invalid @enderror" name="f_r4id">
                                ...
                                @foreach($registers4 as $register)
                                    <option value="{{ $register->f_id }}" {{ selected('f_r4id', $register->f_id) }}>{{ $register->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_r5id') is-invalid @enderror" name="f_r5id">
                                ...
                                @foreach($registers5 as $register)
                                    <option value="{{ $register->f_id }}" {{ selected('f_r5id', $register->f_id) }}>{{ $register->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_departmentid') is-invalid @enderror" name="f_departmentid">
                                ...
                                @foreach($departments as $department)
                                    <option value="{{ $department->f_id }}" {{ selected('f_departmentid', $department->f_id) }}>{{ $department->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_personid') is-invalid @enderror" name="f_personid">
                                ...
                                @foreach($persons as $person)
                                    <option value="{{ $person->f_id }}" {{ selected('f_personid', $person->f_id) }}>{{ $person->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_projectid') is-invalid @enderror" name="f_projectid">
                                ...
                                @foreach($projects as $project)
                                    <option value="{{ $project->f_id }}" {{ selected('f_projectid', $project->f_id) }}>{{ $project->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark1" class="form-check-input @error('f_mark1') is-invalid @enderror" value="{{ old('f_mark1', 1) }}"  {{ old('f_mark1') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark2" class="form-check-input @error('f_mark2') is-invalid @enderror" value="{{ old('f_mark2', 1) }}"  {{ old('f_mark2') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark3" class="form-check-input @error('f_mark3') is-invalid @enderror" value="{{ old('f_mark3', 1) }}"  {{ old('f_mark3') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark4" class="form-check-input @error('f_mark4') is-invalid @enderror" value="{{ old('f_mark4', 1) }}"  {{ old('f_mark4') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark5" class="form-check-input @error('f_mark5') is-invalid @enderror" value="{{ old('f_mark5', 1) }}"  {{ old('f_mark5') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark6" class="form-check-input @error('f_mark6') is-invalid @enderror" value="{{ old('f_mark6', 1) }}"  {{ old('f_mark6') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark7" class="form-check-input @error('f_mark7') is-invalid @enderror" value="{{ old('f_mark7', 1) }}"  {{ old('f_mark7') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_mark8" class="form-check-input @error('f_mark8') is-invalid @enderror" value="{{ old('f_mark8', 1) }}"  {{ old('f_mark8') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_locked" class="form-check-input @error('f_locked') is-invalid @enderror" value="{{ old('f_locked', 1) }}"  {{ old('f_locked') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_sales_block" class="form-check-input @error('f_sales_block') is-invalid @enderror" value="{{ old('f_sales_block', 1) }}"  {{ old('f_sales_block') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_purch_block" class="form-check-input @error('f_purch_block') is-invalid @enderror" value="{{ old('f_purch_block', 1) }}"  {{ old('f_purch_block') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_order_block" class="form-check-input @error('f_order_block') is-invalid @enderror" value="{{ old('f_order_block', 1) }}"  {{ old('f_order_block') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_catalog_item" class="form-check-input @error('f_catalog_item') is-invalid @enderror" value="{{ old('f_catalog_item', 1) }}"  {{ old('f_catalog_item') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_gpais_i" class="form-check-input @error('f_gpais_i') is-invalid @enderror" value="{{ old('f_gpais_i', 1) }}"  {{ old('f_gpais_i') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_gpais_a" class="form-check-input @error('f_gpais_a') is-invalid @enderror" value="{{ old('f_gpais_a', 1) }}"  {{ old('f_gpais_a') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_gpais_n" class="form-check-input @error('f_gpais_n') is-invalid @enderror" value="{{ old('f_gpais_n', 1) }}"  {{ old('f_gpais_n') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_pack_type') is-invalid @enderror" name="f_pack_type">
                                @foreach($pacTypes as $type)
                                    <option value="{{ $type }}" {{ selected('f_pack_type', $type) }}>@lang('modules/stock.gpais_pac_type' . $type)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_prevent_manual_entry" class="form-check-input @error('f_prevent_manual_entry') is-invalid @enderror" value="{{ old('f_prevent_manual_entry', 1) }}"  {{ old('f_prevent_manual_entry') == 1 ? 'checked' : '' }}>
                            </label>
