                            ...
                            <div class="tab">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                                        <form id="stock-form" action="{{ route('stocks.update', $stock) }}"
                                              method="POST">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="col-12 col-xl-4">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($stockGroups as $group)
                                                                <option
                                                                    value="{{ $group->f_id }}" {{ selected('f_groupid', $group->f_id, $stock->f_groupid) }}>{{ $group->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($units as $unit)
                                                                <option
                                                                    value="{{ $unit->f_id }}" {{ selected('f_unitid', $unit->f_id, $stock->f_unitid)}}>{{ $unit->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($units as $unit)
                                                                <option
                                                                    value="{{ $unit->f_id }}" {{ selected('f_pack_unitid', $unit->f_id, $stock->f_pack_unitid) }}>{{ $unit->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($manufacturers as $manufacturer)
                                                                <option
                                                                    value="{{ $manufacturer->f_id }}" {{ selected('f_manufacturerid', $manufacturer->f_id, $stock->f_manufacturerid) }}>{{ $manufacturer->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-12 col-xl-4">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($discountsh as $discounth)
                                                                <option
                                                                    value="{{ $discounth->f_id }}" {{ selected('f_discid', $discounth->f_id, $stock->f_discid) }}>{{ $discounth->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($vats as $vat)
                                                                <option
                                                                    value="{{ $vat->f_id }}" {{ selected('f_vatid', $vat->f_id, $stock->f_vatid) }}>{{ $vat->f_id }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($stockGroups as $group)
                                                                <option
                                                                    value="{{ $group->f_id }}" {{ selected('f_alternative_group_id', $group->f_id, $stock->f_alternative_group_id) }}>{{ $group->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($types as $type)
                                                                <option
                                                                    value="{{ $type }}" {{ selected('f_type', $type, $stock->f_type) }}>@lang('modules/stock.type' . $type)</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <span
                                                        class="form-check-label">@lang('modules/stock.f_weightsign')</span>
                                                            ...
                                                            <input type="checkbox" name="f_weightsign"
                                                                   ...
                                                                   value="{{ old('f_weightsign', 1) }}" {{ old('f_weightsign', $stock->f_weightsign) == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <span
                                                        class="form-check-label">@lang('modules/stock.f_product')</span>
                                                            ...
                                                            <input type="checkbox" name="f_product"
                                                                   ...
                                                                   value="{{ old('f_product', 1) }}" {{ old('f_product', $stock->f_product) == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <span
                                                        class="form-check-label">@lang('modules/stock.f_scalesign')</span>
                                                            ...
                                                            <input type="checkbox" name="f_scalesign"
                                                                   ...
                                                                   value="{{ old('f_scalesign', 1) }}" {{ old('f_scalesign', $stock->f_scalesign) == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($currencies as $currency)
                                                                <option
                                                                    value="{{ $currency->f_id }}" {{ selected('f_curid', $currency->f_id, $stock->f_curid) }}>{{ $currency->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($partners as $partner)
                                                                <option
                                                                    value="{{ $partner->f_id }}" {{ selected('f_partnerid', $partner->f_id, $stock->f_partnerid) }}>{{ $partner->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($accounts as $account)
                                                                <option
                                                                    value="{{ $account->f_id }}" {{ selected('f_accountid', $account->f_id, $stock->f_accountid) }}>{{ $account->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <span
                                                        class="form-check-label">@lang('modules/stock.f_empty_pack')</span>
                                                            ...
                                                            <input type="checkbox" name="f_empty_pack"
                                                                   ...
                                                                   value="{{ old('f_empty_pack', 1) }}" {{ old('f_empty_pack', $stock->f_empty_pack) == 1 ? 'checked' : '' }}>
                                                        </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($stocks as $singleStock)
                                                            <option
                                                                value="{{ $singleStock->f_id }}" {{ selected('f_main_stockid', $singleStock->f_id, $stock->f_main_stockid) }}>{{ $singleStock->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($registers1 as $register)
                                                            <option
                                                                value="{{ $register->f_id }}" {{ selected('f_r1id', $register->f_id, $stock->f_r1id) }}>{{ $register->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($registers2 as $register)
                                                            <option
                                                                value="{{ $register->f_id }}" {{ selected('f_r2id', $register->f_id, $stock->f_r2id) }}>{{ $register->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($registers3 as $register)
                                                            <option
                                                                value="{{ $register->f_id }}" {{ selected('f_r3id', $register->f_id, $stock->f_r3id) }}>{{ $register->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($registers4 as $register)
                                                            <option
                                                                value="{{ $register->f_id }}" {{ selected('f_r4id', $register->f_id, $stock->f_r4id) }}>{{ $register->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($registers5 as $register)
                                                            <option
                                                                value="{{ $register->f_id }}" {{ selected('f_r5id', $register->f_id, $stock->f_r5id) }}>{{ $register->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($departments as $department)
                                                            <option
                                                                value="{{ $department->f_id }}" {{ selected('f_departmentid', $department->f_id, $stock->f_departmentid) }}>{{ $department->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($persons as $person)
                                                            <option
                                                                value="{{ $person->f_id }}" {{ selected('f_personid', $person->f_id, $stock->f_personid) }}>{{ $person->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($projects as $project)
                                                            <option
                                                                value="{{ $project->f_id }}" {{ selected('f_projectid', $project->f_id, $stock->f_projectid) }}>{{ $project->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark1"
                                                               ...
                                                               value="{{ old('f_mark1', 1) }}" {{ old('f_mark1', $stock->f_mark1) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark2"
                                                               ...
                                                               value="{{ old('f_mark2', 1) }}" {{ old('f_mark2', $stock->f_mark2) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark3"
                                                               ...
                                                               value="{{ old('f_mark3', 1) }}" {{ old('f_mark3', $stock->f_mark3) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark4"
                                                               ...
                                                               value="{{ old('f_mark4', 1) }}" {{ old('f_mark4', $stock->f_mark4) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark5"
                                                               ...
                                                               value="{{ old('f_mark5', 1) }}" {{ old('f_mark5', $stock->f_mark5) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark6"
                                                               ...
                                                               value="{{ old('f_mark6', 1) }}" {{ old('f_mark6', $stock->f_mark6) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark7"
                                                               ...
                                                               value="{{ old('f_mark7', 1) }}" {{ old('f_mark7', $stock->f_mark7) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    <label class="form-check m-0">
                                                        ...
                                                        <input type="checkbox" name="f_mark8"
                                                               ...
                                                               value="{{ old('f_mark8', 1) }}" {{ old('f_mark8', $stock->f_mark8) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_locked"
                                                               ...
                                                               value="{{ old('f_locked', 1) }}" {{ old('f_locked', $stock->f_locked) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_sales_block"
                                                               ...
                                                               value="{{ old('f_sales_block', 1) }}" {{ old('f_sales_block', $stock->f_sales_block) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_purch_block"
                                                               ...
                                                               value="{{ old('f_purch_block', 1) }}" {{ old('f_purch_block', $stock->f_purch_block) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_order_block"
                                                               ...
                                                               value="{{ old('f_order_block', 1) }}" {{ old('f_order_block', $stock->f_order_block) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_catalog_item"
                                                               ...
                                                               value="{{ old('f_catalog_item', 1) }}" {{ old('f_catalog_item', $stock->f_catalog_item) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_gpais_i"
                                                               ...
                                                               value="{{ old('f_gpais_i', 1) }}" {{ old('f_gpais_i', $stock->f_gpais_i) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_gpais_a"
                                                               ...
                                                               value="{{ old('f_gpais_a', 1) }}" {{ old('f_gpais_a', $stock->f_gpais_a) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_gpais_n"
                                                               ...
                                                               value="{{ old('f_gpais_n', 1) }}" {{ old('f_gpais_n', $stock->f_gpais_n) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($pacTypes as $type)
                                                            <option
                                                                value="{{ $type }}" {{ selected('f_pack_type', $type, $stock->f_pack_type) }}>@lang('modules/stock.gpais_pac_type' . $type)</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-12 col-xl-4">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           name="f_imgurl"
                                                           maxlength="500"
                                                           value="{{ old('f_imgurl', $stock->f_imgurl)}}">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_ignor_gross_weight"
                                                               ...
                                                               value="{{ old('f_ignor_gross_weight', 1) }}" {{ old('f_ignor_gross_weight', $stock->f_ignor_gross_weight) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <span
                                                        ...
                                                        <input type="checkbox" name="f_prevent_manual_entry"
                                                               ...
                                                               value="{{ old('f_prevent_manual_entry', 1) }}" {{ old('f_prevent_manual_entry', $stock->f_prevent_manual_entry) == 1 ? 'checked' : '' }}>
                                                    </label>
                                                ...
                                                <div class="card">
                                                    <div class="table-responsive">
                                                        <table class="table mb-0 table-sm table-bordered">
                                                            <thead>
                                                            <tr>
                                                                <th scope="col">@lang('modules/price.f_id')</th>
                                                                <th scope="col">@lang('modules/price.f_storeid')</th>
                                                                <th scope="col">@lang('modules/price.f_type')</th>
                                                                <th scope="col">@lang('modules/price.f_price')</th>
                                                                <th scope="col">@lang('modules/price.f_price_orig')</th>
                                                                <th scope="col">@lang('modules/price.f_promotion')</th>
                                                                <th scope="col">@lang('modules/price.f_valid_from')</th>
                                                                <th scope="col">@lang('modules/price.f_valid_till')</th>
                                                                <th scope="col">@lang('global.actions')</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>

                                                            @foreach($pricesSale as $price)
                                                                <tr>
                                                                    <td>{{ $price->f_id }}</td>
                                                                    <td>{{ $price->f_storeid }}</td>
                                                                    <td>{{ $price->f_type }}</td>
                                                                    <td>{{ $price->f_price }}</td>
                                                                    <td>{{ $price->f_price_orig }}</td>
                                                                    <td>{{ $price->f_promotion }}</td>
                                                                    <td>{{ $price->f_valid_from }}</td>
                                                                    <td>{{ $price->f_valid_till }}</td>
                                                                    <td class="table-action">
                                                                        <a href="{{ route('prices.edit', [$stock, $price] ) }}"><i
                                                                                class="align-middle"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('prices.destroy', [$stock, $price]) }}"
