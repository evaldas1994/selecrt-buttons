    ...
    <div class="row mb-2 mb-xl-3">
        ...
        <div class="col-auto ms-auto text-end mt-n1">
            <a href="#" class="btn btn-primary"
               onclick="event.preventDefault();document.getElementById('project-form').submit();">@lang('global.btn_save')</a>
            <a href="{{ route('projects.index') }}" class="btn btn-dark">@lang('global.btn_close')</a>
        </div>
    </div>
    <div class="row">
        <div class="card">
