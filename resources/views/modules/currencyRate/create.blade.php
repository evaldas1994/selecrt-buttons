...
@section('content')
    ...
    <div class="row">
        <form id="currency-rate-form" action="{{ route('currency-rates.store', $currency) }}" method="POST">
            @csrf
