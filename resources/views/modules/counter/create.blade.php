    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="counter-form" action="{{ route('counters.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_copy_to_ano" class="form-check-input @error('f_copy_to_ano') is-invalid @enderror" value="{{ old('f_copy_to_ano', 1) }}"  {{ old('f_copy_to_ano') == 1 ? 'checked' : '' }}>
                            </label>
