...
@section('content')
    <div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-xl-3">
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_name"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_name2"
                                />
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_catalog_group"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                ...
                                <x-form-elements.input-time
                                    ...
                                    :defaultValue="$stockGroup->f_allowed_from"
                                />
                                ...
                                <x-form-elements.input-time
                                    ...
                                    :defaultValue="$stockGroup->f_allowed_to"
                                />
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_ignore_promotion"
                                />
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_perishable_goods"
                                />
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_ignore_voucher"
                                />
                                ...
                                <x-form-elements.select-with-button
                                    ...
                                    :defaultValue="$stockGroup->f_group_parent"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_group_level"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_age_restriction"
                                />
                                ...
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$stockGroup->f_ignor_gross_weight"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_disp_priority"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="400"
                                    :defaultValue="$stockGroup->f_imgurl"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_name_short_lt"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_name_short_en"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$stockGroup->f_name_short_ru"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$stockGroup->f_system1"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$stockGroup->f_system2"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$stockGroup->f_system3"
                                />
                            </div>
                        </div>
                    </div>
        ...
        <x-form-elements.form
            id="stock_group_edit_form"
            route="stock-groups.update"
            :data="$stockGroup"
            method="PUT"
        />
    </div>
