    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="stock-group-form" action="{{ route('stock-groups.update', $stockGroup) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   required
                                   maxlength="20"
                                   value="{{ old('f_id', $stockGroup->f_id)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name', $stockGroup->f_name)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name2', $stockGroup->f_name2)}}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_catalog_group" class="form-check-input @error('f_catalog_group') is-invalid @enderror" value="{{ old('f_catalog_group', 1) }}"  {{ old('f_catalog_group', $stockGroup->f_catalog_group) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_allowed_from', $stockGroup->f_allowed_from)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_allowed_to', $stockGroup->f_allowed_to)}}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_ignore_promotion" class="form-check-input @error('f_ignore_promotion') is-invalid @enderror" value="{{ old('f_ignore_promotion', 1) }}"  {{ old('f_ignore_promotion', $stockGroup->f_ignore_promotion) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_perishable_goods" class="form-check-input @error('f_perishable_goods') is-invalid @enderror" value="{{ old('f_perishable_goods', 1) }}"  {{ old('f_perishable_goods', $stockGroup->f_perishable_goods) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_ignore_voucher" class="form-check-input @error('f_ignore_voucher') is-invalid @enderror" value="{{ old('f_ignore_voucher', 1) }}"  {{ old('f_ignore_voucher', $stockGroup->f_ignore_voucher) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_group_parent') is-invalid @enderror" name="f_group_parent">
                                ...
                                @foreach($stockGroups as $group)
                                    <option value="{{ $group->f_id }}" {{ selected('f_group_parent', $group->f_id, $stockGroup->f_group_parent) }}>{{ $group->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_group_level', $stockGroup->f_group_level)}}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_age_restriction" class="form-check-input @error('f_age_restriction') is-invalid @enderror" value="{{ old('f_age_restriction', 1) }}"  {{ old('f_age_restriction', $stockGroup->f_age_restriction) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_ignor_gross_weight" class="form-check-input @error('f_ignor_gross_weight') is-invalid @enderror" value="{{ old('f_ignor_gross_weight', 1) }}"  {{ old('f_ignor_gross_weight', $stockGroup->f_ignor_gross_weight) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_disp_priority', $stockGroup->f_disp_priority)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="400"
                                   value="{{ old('f_imgurl', $stockGroup->f_imgurl)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name_short_lt', $stockGroup->f_name_short_lt)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name_short_en', $stockGroup->f_name_short_en)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name_short_ru', $stockGroup->f_name_short_ru)}}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system1', $stockGroup->f_system1) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system2', $stockGroup->f_system2) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system3', $stockGroup->f_system3) }}">
