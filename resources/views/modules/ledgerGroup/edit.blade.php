    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="ledger-group-form" action="{{ route('ledger-groups.update', $ledgerGroup) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   required
                                   maxlength="40"
                                   value="{{ old('f_id', $ledgerGroup->f_id)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name', $ledgerGroup->f_name)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_accountid') is-invalid @enderror" name="f_accountid">
                                ...
                                @foreach($accounts as $account)
                                    <option value="{{ $account->f_id }}" {{ selected('f_accountid', $account->f_id, $ledgerGroup->f_accountid) }}>{{ $account->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system1', $ledgerGroup->f_system1) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system2', $ledgerGroup->f_system2) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system3', $ledgerGroup->f_system3) }}">
