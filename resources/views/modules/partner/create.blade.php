                    ...
                    <form id="partner-form" action="{{ route('partners.store') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_price_level') is-invalid @enderror" name="f_price_level">
                                @foreach($priceLevels as $level)
                                    <option value="{{ $level }}" {{ selected('f_price_level', $level) }}>@lang('modules/partner.price_level_type' . $level)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_accountid1') is-invalid @enderror" name="f_accountid1">
                                ...
                                @foreach($accounts as $account)
                                    <option value="{{ $account->f_id }}" {{ selected('f_accountid1', $account->f_id) }}>{{ $account->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_accountid2') is-invalid @enderror" name="f_accountid2">
                                <option value selected>---</option>
                                @foreach($accounts as $account)
                                    <option value="{{ $account->f_id }}" {{ selected('f_accountid2', $account->f_id) }}>{{ $account->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_messagegroupid') is-invalid @enderror" name="f_messagegroupid">
                                ...
                                @foreach($messageGroups as $group)
                                    <option value="{{ $group->f_id }}" {{ selected('f_messagegroupid', $group->f_id) }}>{{ $group->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_discount_card_active" class="form-check-input @error('f_discount_card_active') is-invalid @enderror" value="{{ old('f_discount_card_active', 1) }}"  {{ old('f_discount_card_active') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_vatid') is-invalid @enderror" name="f_vatid">
                                <option value selected>---</option>
                                @foreach($vats as $vat)
                                    <option value="{{ $vat->f_id }}" {{ selected('f_vatid', $vat->f_id) }}>{{ $vat->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_legal_status') is-invalid @enderror" name="f_legal_status">
                                @foreach($legalStatuses as $status)
                                    <option value="{{ $status }}" {{ selected('f_legal_status', $status) }}>@lang('modules/partner.legal_status_type' . $status)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_buyer" class="form-check-input @error('f_buyer') is-invalid @enderror" value="{{ old('f_buyer', 1) }}"  {{ old('f_buyer') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_seller" class="form-check-input @error('f_seller') is-invalid @enderror" value="{{ old('f_seller', 1) }}"  {{ old('f_seller') == 1 ? 'checked' : '' }}>
                            </label>
