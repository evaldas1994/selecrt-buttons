    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="taxd-form" action="{{ route('taxesd.update', $taxd) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_department_name', $taxd->f_department_name) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_tax_code', $taxd->f_tax_code) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system1', $taxd->f_system1) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system2', $taxd->f_system2) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system3', $taxd->f_system3) }}">
