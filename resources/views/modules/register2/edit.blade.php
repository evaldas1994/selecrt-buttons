...
@section('content')
    <div class="container">
        <form method="post" action="{{ route('registers2.update', $register->f_id) }}">
            @method('PATCH')
            @csrf
            ...
            <div class="mb-3">
                <label for="f_name3" class="form-label">Pavadinimas 3</label>
                <input type="text" class="form-control" name="f_name3" value="{{ $register->f_name3 }}">
            </div>

            <div class="mb-3">
                <label for="f_coefficient" class="form-label">Koeficientas</label>
                <input type="text" class="form-control" name="f_coefficient" value="{{ $register->f_coefficient }}">
            </div>
