    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="loyalty-points-form" action="{{ route('loyalty-points.update', $loyaltyPoint) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                value="{{ old('f_validity_points', $loyaltyPoint->f_validity_points) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                name="f_use_points"
                                placeholder="@lang('global.select_date')"
                                value="{{ old('f_use_points', $loyaltyPoint->f_use_points) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                name="f_fix_points"
                                placeholder="@lang('global.select_date')"
                                value="{{ old('f_fix_points', $loyaltyPoint->f_fix_points) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_partner_groupid') is-invalid @enderror" name="f_partner_groupid">
                                ...
                                @foreach($partnerGroups as $group)
                                    <option value="{{ $group->f_id }}" {{ selected('f_partner_groupid', $group->f_id, $loyaltyPoint->f_partner_groupid) }}>{{ $group->f_id }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_discount_card', $loyaltyPoint->f_discount_card)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_operator') is-invalid @enderror" name="f_operator">
                                @foreach($operatorTypes as $type)
                                    <option value="{{ $type }}" {{ selected('f_operator', $type, $loyaltyPoint->f_operator) }}>@lang('modules/loyaltyPoint.operatorType' . $type )</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system1', $loyaltyPoint->f_system1) }}"
                                   readonly>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system2', $loyaltyPoint->f_system2) }}"
                                   readonly>
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system3', $loyaltyPoint->f_system3) }}">
