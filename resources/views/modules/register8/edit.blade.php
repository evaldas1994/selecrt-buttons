...
@section('content')
    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$registers8->f_name"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$registers8->f_name2"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input-date
                                    ...
                                    :defaultValue="$registers8->f_valid_date"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$registers8->f_system1"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$registers8->f_system2"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$registers8->f_system3"
                                />
                            </div>
                        </div>
                    </div>
        ...
        <x-form-elements.form
            id="register8_edit_form"
            route="registers8.update"
            :data="$registers8"
            method="PUT"
        />
    </div>
