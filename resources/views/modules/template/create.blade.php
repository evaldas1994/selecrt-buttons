...
@section('content')
    ...
    <div class="row">
        <div class="card">
            <form id="template-form" action="{{ route('templates.store') }}" method="POST" class="d-flex flex-wrap">
                @csrf
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_op') is-invalid @enderror" name="f_op"
                                ...
                                @foreach($operations as $operation)
                                    <option
                                        value="{{ $operation }}" {{ selected('f_op', $operation) }}>@lang('modules/template.operation_type' . $operation)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_primary_document"
                                       ...
                                       value="{{ old('f_primary_document', 1) }}" {{ old('f_primary_document') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_consignment"
                                       ...
                                       value="{{ old('f_consignment', 1) }}" {{ old('f_consignment') == 1 ? 'checked' : '' }}>
                            </label>
                                                ...
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account1', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account1', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account2', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account2', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account3', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account3', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account16', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account16', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account4', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account4', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account5', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account5', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account6', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account6', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account7', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account7', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account8', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account8', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account9', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account9', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account10', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account10', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account11', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account11', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account12', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account12', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account13', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account13', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account14', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account14', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account15', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account15', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account17', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account17', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account18', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account18', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account19', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account19', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account20', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account20', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account21', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account21', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account22', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account22', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_deb_account23', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    <select
                                                        ...
                                                        @foreach($accounts as $account)
                                                            <option
                                                                value="{{ $account->f_id }}" {{ selected('f_cred_account23', $account->f_id) }}>{{ $account->f_name }}</option>
                                                        @endforeach
                                                    </select>
