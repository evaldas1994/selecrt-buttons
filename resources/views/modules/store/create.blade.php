    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="store-form" action="{{ route('stores.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_store') is-invalid @enderror" name="f_store">
                                ...
                                @foreach($stores as $singleStore)
                                    <option value="{{ $singleStore->f_id }}" {{ selected('f_store', $singleStore->f_id) }}>{{ $singleStore->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="300"
                                   value="{{ old('f_store_email', '0000176379')}}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_noexported" class="form-check-input @error('f_noexported') is-invalid @enderror" value="{{ old('f_noexported', 1) }}"  {{ old('f_noexported') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_price_by_store" class="form-check-input @error('f_price_by_store') is-invalid @enderror" value="{{ old('f_price_by_store', 1) }}"  {{ old('f_price_by_store') == 1 ? 'checked' : '' }}>
                            </label>
