    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="work-shedule-template-form" action="{{ route('work-shedule-templates.update', $workSheduleTemplate) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   required
                                   maxlength="20"
                                   value="{{ old('f_id', $workSheduleTemplate->f_id)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="50"
                                   value="{{ old('f_title', $workSheduleTemplate->f_title)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_from', $workSheduleTemplate->f_from)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_till', $workSheduleTemplate->f_till)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_break_from', $workSheduleTemplate->f_break_from)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_break_till', $workSheduleTemplate->f_break_till)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_break_from2', $workSheduleTemplate->f_break_from2)}}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="time"
                                   ...
                                   maxlength="20"
                                   value="{{ old('f_break_till2', $workSheduleTemplate->f_break_till2)}}">
