    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="period-form" action="{{ route('periods.update', $period) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name', $period->f_name) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                value="{{ old('f_begin', $period->f_begin) }}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_closed" class="form-check-input @error('f_closed') is-invalid @enderror" value="{{ old('f_closed', 1) }}" {{ $period->f_closed ? 'checked' : '' }}>
                            </label>
