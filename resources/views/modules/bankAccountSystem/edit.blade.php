...
@section('content')
    <div>
        <div class="row mb-2">
            ...
            <div class="col-auto ms-auto text-end mt-n1">
                <x-form-elements.button
                    form="bank_account_system_edit_form"
                    class="btn-primary"
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input-id
                                    ...
                                    :defaultValue="$bankAccountSystem->f_id"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.select-with-button
                                    ...
                                    :defaultValue="$bankAccountSystem->f_bankid"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$bankAccountSystem->f_name"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$bankAccountSystem->f_default"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$bankAccountSystem->f_system1"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$bankAccountSystem->f_system2"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$bankAccountSystem->f_system3"
                                />
                            </div>
                        </div>
                    </div>
        ...
        <x-form-elements.form
            id="bank_account_system_edit_form"
            route="bank-account-systems.update"
            :data="$bankAccountSystem"
            method="PUT"
        />
    </div>
@endsection
