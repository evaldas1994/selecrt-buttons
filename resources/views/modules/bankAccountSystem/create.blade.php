    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="bank-account-system-form" action="{{ route('bank-account-systems.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-2">
                            ...
                            <select class="not-empty form-control form-control-sm @error('f_bankid') is-invalid @enderror" name="f_bankid" value="{{ old('f_bankid') }}">
                                ...
                                @foreach($banks as $bank)
                                    <option value="{{ $bank->f_id }}" {{ selected('f_bankid',$bank->f_id) }}>{{ $bank->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_default" class="form-check-input @error('f_default') is-invalid @enderror" value="{{ old('f_default', 1) }}">
                            </label>
