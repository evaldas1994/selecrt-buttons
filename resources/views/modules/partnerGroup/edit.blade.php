...
@section('content')
    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$partnerGroup->f_name"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    :defaultValue="$partnerGroup->f_name2"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.checkbox-boolean
                                    ...
                                    :defaultValue="$partnerGroup->f_import"
                                />
                            </div>
                            <div class="col-12 col-md-6 col-xl-3">
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$partnerGroup->f_system1"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$partnerGroup->f_system2"
                                />
                                ...
                                <x-form-elements.input
                                    ...
                                    maxLength="100"
                                    hidden="hidden"
                                    :defaultValue="$partnerGroup->f_system3"
                                />
                            </div>
                        </div>
                    </div>
        ...
        <x-form-elements.form
            id="partner_group_edit_form"
            route="partner-groups.update"
            :data="$partnerGroup"
            method="PUT"
        />
    </div>
