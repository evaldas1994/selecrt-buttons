    ...
    <div class="row">
        <div class="card">
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form id="bank-account-system-form" action="{{ route('partner-groups.update', $partnerGroup) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   required
                                   maxlength="20"
                                   value="{{ old('f_id', $partnerGroup->f_id) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name', $partnerGroup->f_name) }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_name2', $partnerGroup->f_name2) }}">
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input
                                    type="checkbox"
                                    name="f_import" class="form-check-input @error('f_import') is-invalid @enderror"
                                    value="{{ old('f_import', 1) }}"
                                    {{ $partnerGroup->f_import == '1' ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system1', $partnerGroup->f_system1) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system2', $partnerGroup->f_system2) }}">
                        ...
                        <div class="mb-2" hidden>
                            ...
                            <input type="text"
                                   ...
                                   maxlength="100"
                                   value="{{ old('f_system3', $partnerGroup->f_system3) }}">
