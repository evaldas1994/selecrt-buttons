...
@section('content')
    ...
    <div class="row">
        <form id="bank-account-form" action="{{ route('bank-accounts.update', [$partner, $bankAccount]) }}"
              method="POST">
            @csrf
            @method('PUT')
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                           ...
                                           required
                                           maxlength="20"
                                           value="{{ old('f_id', $bankAccount->f_id)}}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select
                                        ...
                                        @foreach($banks as $bank)
                                            <option
                                                value="{{ $bank->f_id }}" {{ selected('f_bankid', $bank->f_id, $bankAccount->f_bankid) }}>{{ $bank->f_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-2">
                                    <label class="form-check m-0">
                                        ...
                                        <input type="checkbox" name="f_default"
                                               ...
                                               value="{{ old('f_default', 1) }}" {{ old('f_default', $bankAccount->f_default) == 1 ? 'checked' : '' }}>
                                    </label>
