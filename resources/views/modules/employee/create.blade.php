                    ...
                    <form id="employee-form" action="{{ route('employees.store') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_subdivision') is-invalid @enderror" name="f_subdivision">
                                ...
                                @foreach($departments as $department)
                                    <option value="{{ $department->f_id }}" {{ selected('f_subdivision', $department->f_id) }}>{{ $department->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_married') is-invalid @enderror" name="f_married">
                                @foreach($maritalStatuses as $status)
                                    <option value="{{ $status }}" {{ selected('f_married', $status) }}>@lang('modules/employee.maritalStatusType' . $status)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_userid') is-invalid @enderror" name="f_userid">
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->f_id }}" {{ selected('f_userid', $user->f_id) }}>{{ $user->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_uses_pi') is-invalid @enderror" name="f_uses_pi">
                                @foreach($pensionInsurances as $insurance)
                                    <option value="{{ $insurance }}" {{ selected('f_uses_pi', $insurance) }}>@lang('modules/employee.pensionInsuranceType' . $insurance)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text"
                                   ...
                                   maxlength="50"
                                   value="{{ old('f_social_insurance_id')}}">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_direct_debit_bank') is-invalid @enderror" name="f_direct_debit_bank">
                                ...
                                @foreach($banks as $bank)
                                    <option value="{{ $bank->f_id }}" {{ selected('f_direct_debit_bank', $bank->f_id) }}>{{ $bank->f_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_fired" class="form-check-input @error('f_fired') is-invalid @enderror" value="{{ old('f_fired', 1) }}"  {{ old('f_fired') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_sex') is-invalid @enderror" name="f_sex">
                                @foreach($sexTypes as $type)
                                    <option value="{{ $type }}" {{ selected('f_sex', $type) }}>@lang('modules/employee.sexType' . $type)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_disablement') is-invalid @enderror" name="f_disablement">
                                @foreach($disablementTypes as $type)
                                    <option value="{{ $type }}" {{ selected('f_disablement', $type) }}>@lang('modules/employee.disablementType' . $type)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_uses_nti" class="form-check-input @error('f_uses_nti') is-invalid @enderror" value="{{ old('f_uses_nti', 1) }}"  {{ old('f_uses_nti') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_cash" class="form-check-input @error('f_cash') is-invalid @enderror" value="{{ old('f_cash', 1) }}"  {{ old('f_cash') == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check m-0">
                                ...
                                <input type="checkbox" name="f_uses_vsd" class="form-check-input @error('f_uses_vsd') is-invalid @enderror" value="{{ old('f_uses_vsd', 1) }}"  {{ old('f_uses_vsd', 1) == 1 ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_work_shedule_template') is-invalid @enderror" name="f_work_shedule_template">
                                ...
                                @foreach($workSheduleTemplates as $template)
                                    <option value="{{ $template->f_id }}" {{ selected('f_work_shedule_template', $template->f_id) }}>{{ $template->f_title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control form-control-sm @error('f_disability_perc') is-invalid @enderror" name="f_disability_perc">
                                @foreach($disablementPercentTypes as $type)
                                    <option value="{{ $type }}" {{ selected('f_disability_perc', $type) }}>@lang('modules/employee.disablementPercentType' . $type)</option>
                                @endforeach
                            </select>
