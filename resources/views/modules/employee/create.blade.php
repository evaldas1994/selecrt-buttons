                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($departments as $department)
                                                                <option
                                                                    value="{{ $department->f_id }}" {{ selected('f_subdivision', $department->f_id) }}>{{ $department->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($maritalStatuses as $status)
                                                                <option
                                                                    value="{{ $status }}" {{ selected('f_married', $status) }}>@lang('modules/employee.maritalStatusType' . $status)</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($users as $user)
                                                                <option
                                                                    value="{{ $user->f_id }}" {{ selected('f_userid', $user->f_id) }}>{{ $user->f_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($pensionInsurances as $insurance)
                                                                <option
                                                                    value="{{ $insurance }}" {{ selected('f_uses_pi', $insurance) }}>@lang('modules/employee.pensionInsuranceType' . $insurance)</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-check m-0">
                                                            ...
                                                            <input type="checkbox" name="f_fired"
                                                                   ...
                                                                   value="{{ old('f_fired', 1) }}" {{ old('f_fired') == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($sexTypes as $type)
                                                                <option
                                                                    value="{{ $type }}" {{ selected('f_sex', $type) }}>@lang('modules/employee.sexType' . $type)</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($disablementTypes as $type)
                                                                <option
                                                                    value="{{ $type }}" {{ selected('f_disablement', $type) }}>@lang('modules/employee.disablementType' . $type)</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-check m-0">
                                                            ...
                                                            <input type="checkbox" name="f_uses_nti"
                                                                   ...
                                                                   value="{{ old('f_uses_nti', 1) }}" {{ old('f_uses_nti') == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-check m-0">
                                                            ...
                                                            <input type="checkbox" name="f_cash"
                                                                   ...
                                                                   value="{{ old('f_cash', 1) }}" {{ old('f_cash') == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-check m-0">
                                                            ...
                                                            <input type="checkbox" name="f_uses_vsd"
                                                                   ...
                                                                   value="{{ old('f_uses_vsd', 1) }}" {{ old('f_uses_vsd', 1) == 1 ? 'checked' : '' }}>
                                                        </label>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($workSheduleTemplates as $template)
                                                                <option
                                                                    value="{{ $template->f_id }}" {{ selected('f_work_shedule_template', $template->f_id) }}>{{ $template->f_title }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach($disablementPercentTypes as $type)
                                                                <option
                                                                    value="{{ $type }}" {{ selected('f_disability_perc', $type) }}>@lang('modules/employee.disablementPercentType' . $type)</option>
                                                            @endforeach
                                                        </select>
