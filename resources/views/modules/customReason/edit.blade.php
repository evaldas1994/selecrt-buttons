...
@section('content')
    ...
    <div class="row">
        <form id="custom-reason-form" action="{{ route('custom-reasons.update', $customReason) }}" method="POST">
            @csrf
            @method('PUT')
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_description"
                                           maxlength="100"
                                           value="{{ old('f_description', $customReason->f_description)}}">
                            ...
                            <div class="col-12 col-xl-3">
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system1"
                                           maxlength="100"
                                           value="{{ old('f_system1', $customReason->f_system1) }}">
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system2"
                                           maxlength="100"
                                           value="{{ old('f_system2', $customReason->f_system2) }}">
                                ...
                                <div class="mb-2" hidden>
                                    ...
                                    <input type="text"
                                           ...
                                           name="f_system3"
                                           maxlength="100"
                                           value="{{ old('f_system3', $customReason->f_system3) }}">
